...
public class ChatingAPP implements ActionListener
{
    JPanel p1;
    JTextField t;
    JButton b1;
     ...
     ChatingAPP()
    {
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("chatingapp/icon/lalit.jpg"));
        ...
        JLabel l3=new JLabel("Lalit Gurjar");
   ...
   public static JPanel formatLabel(String out ){
    ...
    public static void main(String[] args) {
        new ChatingAPP().f1.setVisible(true);
        
        
        String msginput= " ";
        try
        {
          skt=new ServerSocket(6006);
